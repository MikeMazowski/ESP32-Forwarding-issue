...
*/
#define EXAMPLE_ESP_WIFI_AP_SSID      "Device3"
#define EXAMPLE_ESP_WIFI_AP_PASS      "12345678"
#define EXAMPLE_MAX_STA_CONN          4

#define EXAMPLE_ESP_WIFI_STA_SSID     "Whenever"
#define EXAMPLE_ESP_WIFI_STA_PASS     "Wherever"
